...
const createGlobalProxyAgent = (configurationInput = defaultConfigurationInput) => {
  ...
  const BoundHttpProxyAgent = class extends _classes.HttpProxyAgent {
    constructor() {
      super(() => {
        return getHttpProxy();
      }, mustUrlUseProxy(getHttpProxy), getUrlProxy(getHttpProxy), _http.default.globalAgent);
    }
  ...
  const BoundHttpsProxyAgent = class extends _classes.HttpsProxyAgent {
    constructor() {
      ...
      }, mustUrlUseProxy(getHttpsProxy), getUrlProxy(getHttpsProxy), _https.default.globalAgent);
    }
